...
export const levels = [
  /* ---------------- Level 1 ---------------- */
  {
    ...
    juist: 'draad',
    uitlegGoed: 'Raak! Circuit compleet.',
    uitlegFout: 'Nog niet helemaal goed, probeer nog een keer.',
    motivatie: null,
  ...
  /* ---------------- Level 2 ---------------- */
  {
    ...
    juist: 'relais',
    uitlegGoed: 'Yes, precies de juiste component!',
    uitlegFout: 'Bijna, denk nog eens na over wat er moet gebeuren.',
  ...
  /* ---------------- Level 3 ---------------- */
  {
    ...
    situatie: 'De installatie doet het niet. Tijd om uit te zoeken waar het misgaat.',
    ...
    juist: 'automaat',
    uitlegGoed: 'Scherp gezien, dat is de juiste eerste check.',
    uitlegFout: 'Niet de juiste eerste stap, kijk nog eens.',
  ...
  /* ---------------- Level 4 ---------------- */
  {
    ...
    situatie: 'Spanning is er, maar de motor doet niks. Zoek de boosdoener.',
    ...
    uitlegGoed: 'Gevonden! Zo denkt een monteur.',
    uitlegFout: 'Nog niet de juiste plek, blijf zoeken.',
    motivatie: null,
